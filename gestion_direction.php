<?php 
    ...
    if(isset($_GET["cat"])){
      ...
      $suppression->supprimer_dir($_GET["cat"]);
      ...
      echo "<script language='javascript'>
          setInterval(function(){
            window.location= 'gestion_direction';
          }, 2500);
          </script>";
    }
    //Fin suppression
          ...
          <div class="col-md-12" style="margin-bottom: 25px">           
            ...
            <div class="card">
              ...
              <div class="card-header">
                <h3 class="card-title"></i>Ajouter Une Direction</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              ...
              <div class="card-footer">
                ...
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputEmail3" placeholder="nom de la catégorie" name="nom_dir">
                    </div>
                  </div>
                </div>
                <div class="form-group row">
