<?php 
    ...
    if(isset($_POST["modifier"])){
     ...
     $idycat=$_GET["sit"];
        if(!empty($ville)){
            ...
            $modificteur= new ville;
            $modificteur->modifierVille($ville, $idycat);
    ...
    if(isset($_POST["enregister"])){
      ...
      $libelle=htmlspecialchars(strip_tags($_POST["ville"]));
      //instanciation de notre classe pour utiliser le bouton d'enregistrement
      $ajoutervil= new ville();
      $ajoutervil->addville($ville,$dateEn);
    }
    //suppression des donnees
    
    if(isset($_POST["suppresion"])){
      $suppression = new ville;
      $suppression->supprimerVille($_POST["delca"]);
          ...
          <div class="col-md-12" style="margin-bottom: 25px">           
            ...
            <div class="card">
              ...
              <div class="card-header">
                <h3 class="card-title"></i>Ajouter</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              ...
              <?php
                ...
                <div class="card-body">
                  <div class="form-group row">
                      <?php 
                      $getidcat_mod=$_GET["sit"];
                      if(!empty($getidcat_mod)){
                        $affichageMod= new ville;
                        $affichageMod->affmodVille($getidcat_mod);
                      }else{
