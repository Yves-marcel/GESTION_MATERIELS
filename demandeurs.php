                   ...
                   if (empty($_GET['action'])){
                    ...
                    ?>
                        <center>
                         ...
                         <h5 style="padding: 5px">  <a href="demandeurs?action=ordi"><i class="fa fa-desktop">  </i> Ordinateur</a> </h5>
                         <h5 style="padding: 5px">  <a href="demandeurs?action=imprimante"> <i class="fa fa-print">  </i> Imprimante</a> </h5>
