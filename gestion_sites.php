<?php 
    ...
    if(isset($_GET["sit"])){
      ...
      $suppression->supprimerVille($_GET["sit"]);
          ...
          <div class="col-md-12" style="margin-bottom: 25px">           
            ...
            <div class="card">
              ...
              <div class="card-header">
                <h3 class="card-title"></i>Ajouter un site</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              ...
              <div class="card-footer">
                ...
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputEmail3" placeholder="nom de la Ville" name="ville">
                    </div>
                  </div>
                </div>
